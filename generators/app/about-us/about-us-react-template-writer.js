...
function write(generator) {
    ...
    generator.navElementKey = _.lowerCase(_.trim(generator.titleText)).replace(' ', '-').replace('_', '-');
    const titleTextKebabCase = generator.navElementKey.trim().replace(' ', '-').replace('_', '-');
    generator.cssName = `${_.kebabCase(titleTextKebabCase).toLowerCase()}.css`;
    generator.scssName = `${_.kebabCase(titleTextKebabCase).toLowerCase()}.scss`;
    ...
    generator.translationKeyMenu = _.kebabCase(titleTextKebabCase).toLowerCase();
    ...
    generator.componentTsName = `${_.kebabCase(titleTextKebabCase).toLowerCase()}.component`;
    generator.routerName = _.kebabCase(titleTextKebabCase).toLowerCase();
    generator.routeName = `${_.kebabCase(titleTextKebabCase).toUpperCase().replace('-', '_')}_ROUTE`;
    generator.routeTsName = `${_.kebabCase(titleTextKebabCase).toLowerCase()}.route`;
    ...
    generator.moduleTsNameMinusSuffix = _.kebabCase(titleTextKebabCase).toLowerCase();
    generator.moduleTsName = `${_.kebabCase(titleTextKebabCase).toLowerCase()}.module`;
    generator.pageTitle = `${_.kebabCase(titleTextKebabCase).toLowerCase()}.title`;
    generator.tabName = _.upperFirst(_.kebabCase(titleTextKebabCase).replace('-', ' '));
    ...
    const componentName = _.kebabCase(titleTextKebabCase).toLowerCase();
    const componentDirName = _.kebabCase(titleTextKebabCase).toLowerCase();
