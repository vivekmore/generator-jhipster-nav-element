(function () {
    ...
    angular
        ...
        .controller('<%=navElementKeyCapitalized%>Controller', <%=navElementKeyCapitalized%>Controller);

    <%=navElementKeyCapitalized%>Controller.$inject = ['$scope', '<%=navElementKeyCapitalized%>Service'];

    function <%=navElementKeyCapitalized%>Controller($scope, <%=navElementKeyCapitalized%>Service) {
        var vm = this;
